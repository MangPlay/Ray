...
void ARayCharacter::ServerUpdateEquipmentMesh_Implementation(EItemSlot ItemSlot, USkeletalMesh* InSkeletaMesh)
{
}
...
void ARayCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ARayCharacter::Look);
		*/
	}
	else
	{
...
void ARayCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
